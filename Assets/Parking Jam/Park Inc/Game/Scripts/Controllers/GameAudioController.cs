...
public class GameAudioController : MonoBehaviour
{
    ...
    public static void PlayFinishAudio()
    {
        ...
        AudioController.PlaySound(AudioController.Sounds.finishAudioClip,0.2f);
    }
    ...
    public static void PlayDrivingAwayAudioNew(AudioClip audioClip)
    {
        if (!SoundEnabled) return;

        AudioController.PlaySound(audioClip,0.25f);
    }
    ...
    public static void PlayHornLongAudio()
    {
        if (!SoundEnabled) return;

        Tween.DelayedCall(0.1f, () => AudioController.PlaySound(AudioController.Sounds.hornLong));
    }
}
