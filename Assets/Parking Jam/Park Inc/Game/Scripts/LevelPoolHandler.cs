...
public class LevelPoolHandler : MonoBehaviour
{
    ...
    {
        for (int i = 0; i < GameControllerParkingJam.LevelDatabase.ObstaclesCount; i++)
        {
            Obstacle obstacle = GameControllerParkingJam.LevelDatabase.GetObstacle(i);
    ...
    public static void InitMovablePools() //total cars
    {
        int movableObjectsCount = GameControllerParkingJam.LevelDatabase.MovableObjectsCount;
        for(int i = 0; i < movableObjectsCount; i++)
        {
            MovableObject movable = GameControllerParkingJam.LevelDatabase.GetMovableObject(i);
