...
namespace Watermelon
{
    ...
    public class StoreDatabaseEditor : WatermelonEditor
    {
        ...
        private readonly string CHARACTER_SKIN_PRICE_PROP_NAME = "characterSkinPrice";
        private readonly string ENVIRONMENT_SKIN_PRICE_PROP_NAME = "environmentSkinPrice";
        private readonly string COINS_FOR_ADS_AMOUNT_PROP_NAME = "coinsForAdsAmount";

        private SerializedProperty productsProperty;
        private SerializedProperty characterSkinPriceProperty;
        private SerializedProperty environmentSkinPriceProperty;
        ...
        protected override void OnEnable()
        {
            ...
            characterSkinPriceProperty = serializedObject.FindProperty(CHARACTER_SKIN_PRICE_PROP_NAME);
            environmentSkinPriceProperty = serializedObject.FindProperty(ENVIRONMENT_SKIN_PRICE_PROP_NAME);
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(characterSkinPriceProperty);
            EditorGUILayout.PropertyField(environmentSkinPriceProperty);
