...
public class DuoInt
{
    ...
    {
        return Random.Range(firstValue, secondValue + 1); // Because second parameter is exclusive. Withot + 1 method Random.Range(1,2) will always return 1
    }
...
public class DuoFloat
{
    ...
    {
        return Random.Range(firstValue, secondValue);
    }
...
public class DuoVector3
{
    ...
    public Vector3 RandomBetween()
    {
        return new Vector3(Random.Range(firstValue.x, secondValue.x), Random.Range(firstValue.y, secondValue.y), Random.Range(firstValue.z, secondValue.z));
    }
