...
//		angleV += Mathf.Clamp(Input.GetAxis(YAxis), -1, 1) * 60 * verticalAimingSpeed * Time.deltaTime;
		...
		//angleH += Mathf.Clamp(ControlFreak2.CF2Input.GetAxis("Mouse X"), -1, 1) * horizontalAimingSpeed;  //mjr
		//angleV += Mathf.Clamp(ControlFreak2.CF2Input.GetAxis("Mouse Y"), -1, 1) * verticalAimingSpeed;   //mjr
		//// Joystick:
		//angleH += Mathf.Clamp(ControlFreak2.CF2Input.GetAxis(XAxis), -1, 1) * 60 * horizontalAimingSpeed * Time.deltaTime;   //mjr
		//angleV += Mathf.Clamp(ControlFreak2.CF2Input.GetAxis(YAxis), -1, 1) * 60 * verticalAimingSpeed * Time.deltaTime;   //mjr
	...
	bool ViewingPosCheck (Vector3 checkPos, float deltaPlayerHeight)
	{
		...
		if (Physics.SphereCast(checkPos, 0.2f, target - checkPos, out  hit, relCameraPosMag))
		{
