...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    {
		[SerializeField] private Transform extra_m_PropellorModel;                          // The model of the the aeroplane's propellor.
        ...
        private void Update()
        {
			...
			if (m_Plane.Throttle == 0)
				effector = 5.1f;

			m_PropellorModel.Rotate(0, 0, m_MaxRpm*m_Plane.Throttle*Time.deltaTime*k_RpmToDps+effector);
			extra_m_PropellorModel.Rotate(0, 0, m_MaxRpm*m_Plane.Throttle*Time.deltaTime*k_RpmToDps+effector);
