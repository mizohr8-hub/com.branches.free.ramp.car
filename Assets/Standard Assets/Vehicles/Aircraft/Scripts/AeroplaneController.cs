...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        private void CalculateForwardSpeed()
        {
			...
			if (transform.InverseTransformDirection (m_Rigidbody.velocity) != null) {
        ...
        private void CalculateAltitude()
        {
			...
			if (Altitude > 10.0f && !GameObject.Find ("FireMissile (2)").GetComponent<UnityEngine.UI.Image> ().enabled)
				GameObject.Find ("FireMissile (2)").GetComponent<UnityEngine.UI.Image> ().enabled = true;
        }
