    ...
    public class RaceUI : MonoBehaviour
    {
        ...
        void DefaultUI()
        {
            ...
            if (racingUI.lap)
            {
                ...
                if(RaceManager.instance.totalLaps == 0)
                {
        ...
        public void UpdateUIPanels()
        {
            ...
            switch (RaceManager.instance._raceState)
            {
                ...
                case RaceManager.RaceState.Complete:
                    ...
                    //{
                    //    GeneralScript.instance.carGiftPanel.SetActive(true);
                    //}
        ...
        void ShowRaceResults()
        {
            if (raceResults.Count > 0)
            {
                for (int i = 0; i < RankManager.instance.totalRacers; i++)
                {
                    ...
                    //Position
                    if (raceResults[i].position) raceResults[i].position.text =_statistics.rank.ToString();// RankManager.instance.currentRacers.ToString();  //
        ...
        public void StartCountDown(float time)
        {
            ...
            GameObject sp = GameObject.FindGameObjectWithTag("StartPoint");
            //sp.GetComponent<Animator>().enabled = true;
        }
        ...
        public void Exit()
        {
            ...
            {
                Time.timeScale = 1;
                StartCoroutine(ScreenFadeIn(fadeSpeed * 2, true, "MainMenu"));
                PlayerPrefs.GetInt("PlayingRacing", 0);
