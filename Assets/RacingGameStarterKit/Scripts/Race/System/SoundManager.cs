...
namespace RGSK
{
    ...
    public class SoundManager : MonoBehaviour
    {
        ...
        {
            public AudioClip countdownSound, countdownSound2, countdownSound1;
            public AudioClip[] countdownSoundNew;
        ...
        //{
        //    StartCoroutine("Play321", 0f);
        //}
        //bool isPlayed = false; //mjr

        //IEnumerator Play321()
        //{
        //    if (!isPlayed)
        //    {
        //        audioSource.PlayOneShot(defaultSounds.countdownSound);
        //        yield return new WaitForSeconds(1f);
        //        audioSource.PlayOneShot(defaultSounds.countdownSound2);
        //        yield return new WaitForSeconds(1f);
        //        audioSource.PlayOneShot(defaultSounds.countdownSound1);
        //       // yield return new WaitForSeconds(1f);
