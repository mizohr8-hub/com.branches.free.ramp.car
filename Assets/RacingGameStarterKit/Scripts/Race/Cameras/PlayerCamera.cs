...
namespace RGSK
{
    ...
    public class PlayerCamera : MonoBehaviour
    {
        ...
        public bool lookLeft, lookRight, lookBack, lookFront;
        ...
        void ChaseCamera()
        {
            ...
            if (!lookLeft && !lookRight && !lookBack && !lookFront) wantedRotationAngle = target.eulerAngles.y;
...
//                print("Camera Rotated");
            ...
            if (lookBack)
            {
                //Debug.Log("Back Stunt Persofmed");
