...
namespace RGSK
{
    public class DataLoader : MonoBehaviour
    {
        ...
        public void LoadRacePreferences()
        {
           ...
           // if (PlayerPrefs.HasKey("PlayerVehicle"))  //mjr
            {
            ...
            if (PlayerPrefs.HasKey("Laps"))
            {
                ...
                //RaceManager.instance.totalLaps = PlayerPrefs.GetInt("Laps"); //mjr
                RaceManager.instance.totalLaps = 3;
            }
            ...
            if (PlayerPrefs.HasKey("Opponents"))
            {
               ...
               // RaceManager.instance.totalRacers = PlayerPrefs.GetInt("Opponents") + 1;    //mjr
               // RaceManager.instance.totalRacers = PlayerPrefs.GetInt("Opponents") + 1;    //mjr
            }
