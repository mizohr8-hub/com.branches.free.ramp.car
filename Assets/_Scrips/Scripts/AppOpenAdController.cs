...
namespace GoogleMobileAds.Sample
{
    ...
    public class AppOpenAdController : MonoBehaviour
    {
...
#if UNITY_ANDROID
        public string _adUnitId = "ca-app-pub-3940256099942544/3419835294";
#elif UNITY_IPHONE
        ...
        void OnAppStateChanged1()
        {
            // ShowAd();//Haider Stopped ADs
        }
        void OnAppStateChanged1(AppState state)
        {
