...
namespace GoogleMobileAds.Sample
{
    ...
    public class RewardedAdController : MonoBehaviour
    {
        ...
        RewardedVideoSetup Selected_Rewarder1;


        public void ShowAd(AdmobRewardedVideo admobRewarded = null)
        {
        ...
        public void ShowAdOne(RewardedVideoSetup admobRewarded = null)
        {
            Selected_Rewarder1 = admobRewarded;
        ...
        private void RegisterEventHandlers(RewardedAd ad)
        {
            ...
            {
                if (PlayerPrefs.GetInt("PlayingWheelShot") == 1)
                {
                    Selected_Rewarder1.RewardAfterAd();
                }
                else
                {
                    Selected_Rewarder.RewardAfterAd();
                }
