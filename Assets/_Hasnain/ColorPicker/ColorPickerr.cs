...
public class ColorPickerr : MonoBehaviour
{

    public bool showPicker = false;
    public Color setColorBody;
    ...
    public MainMenu_Customize carpart;
    ...
    void OnGUI()
    {
        ...
        if (GUI.RepeatButton(new Rect(positionLeft, positionTop, textureWidth, textureHeight), displayPicker))
        {
            ...
            clickDown = true;
                ...
                setColorBody = displayPicker.GetPixel(a - positionLeft, -(b - positionTop));
                lastSetColor = setColorBody;
